...
from domainbed.models.hypernet import PrimaryNetwork
...
class HYPERNET(Algorithm):
    ...
    def __init__(self, input_shape, num_classes, num_domains, hparams, **kwargs):
        ...
        # self.network = torch.hub.load('pytorch/vision:v0.10.0', 'resnet18', pretrained=True)
        self.ld = hparams.ld
